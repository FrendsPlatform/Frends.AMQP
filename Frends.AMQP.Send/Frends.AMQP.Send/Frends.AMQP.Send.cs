...
public static class AMQP
{
    ...
    public static async Task<Result> Send([PropertyTab] Input input, [PropertyTab] Options options, [PropertyTab] AmqpMessageProperties messageProperties, CancellationToken cancellationToken)
    {
